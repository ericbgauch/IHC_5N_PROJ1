...
outras disciplinas das ciências exatas, por exemplo, física e química, a
matemática se torna uma verdadeira armadilha para o bom desempenho. Muitos
acreditam que isso se deve pela forma como ela é desenvolvida, ou seja, como
ela está no currículo para ser cumprida. Além de outras questões, bem como a
interação com algo concreto, que a criança possa realcionar com a aplicação.

Acredita-se que ensinando aos alunos uma matemáica "viva" e ajudando a
estabelecer uma relação entre a disciplina e o cotidiano daquele jovem é uma
das formas de diminuir a rejeição pela matemática, pois deixa o aluno frente a
uma matemática com vida.
